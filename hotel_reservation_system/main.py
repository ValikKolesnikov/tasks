...
def main():
    ...
    hotel.allocate_room(person=person_1, room=room, date_start=datetime(2021, 1, 2), date_end=datetime(2021, 1, 5))
    hotel.allocate_room(person=person_2, room=room, date_start=datetime(2021, 1, 8), date_end=datetime(2021, 1, 12))
    hotel.allocate_room(person=person_3, room=room, date_start=datetime(2021, 1, 1), date_end=datetime(2021, 1, 6))
